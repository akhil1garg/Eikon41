...
namespace ThomsonReuters.Test.WhiteArk.Apps.NA
{
    public class ChartAppWebApp : GCPAppBase
    {
        ...
        public ChartAppWebApp(IEikonDriver eikonDriver, string windowTitle)
            : base(eikonDriver)
        {
            Url = eikonDriver.RootUrl + DIRECT_PATH;
        }

        public ChartAppWebApp(IEikonDriver eikonDriver)
        ...
        public IWebElement Chartpopout
        {
            get { return WebDriver.FindElement(By.XPath("//*[@id='container']/div/coral-panel/app-top-apps/div/virtual-scroller/div[2]/div[2]/div[1]/app-tile[1]/div/div/div[2]/div[2]/coral-button")); }
        }
